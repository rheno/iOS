...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    MainTableView* mainTableView = [[MainTableView alloc] initWithNibName:@"MainTableView" bundle:nil];
    self.navigationController = [[[UINavigationController alloc] initWithRootViewController:mainTableView] autorelease];
    
    mainTableView.managedObjectContext = self.managedObjectContext;
...
//    
//    for (Users *users in fetchedObjects) {
//        // Log the label details
//        NSLog(@"%@, %@, %@", users.id,users.username, users.password);
//    }
//}
//
//- (void) update {
...
//    // Grab the label
//    Users *users = [fetchedObjects objectAtIndex:0];
//    
//        
//    // Save everything
//    if ([context save:&error]) {
...
//    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"name == %@", @"pler"];
...
//    Users *users = [fetchedObjects objectAtIndex:0];
//    
//    [self.managedObjectContext deleteObject:users];
//    // Save everything
//    if ([context save:&error]) {
//        NSLog(@"The save was successful!");
//    } else {

...
- (BOOL) createNewStudentWithName:(NSString *)paramName
    ...
    newStudent.name = paramName;
    newStudent.studentNumber = [NSNumber numberWithUnsignedInteger:paramStudentNumber];
    newStudent.age = [NSNumber numberWithUnsignedInteger:paramAge];
...
-(BOOL)deleteStudent{
    ...
    NSArray *students = [self.managedObjectContext executeFetchRequest:fetchRequest error:&requestError];
    
    [_managedObjectContext deleteObject:[students objectAtIndex:1]];
    NSError *error = nil;
...
-(BOOL)updateStudentAtIndex:(int)index
    ...
    [[students objectAtIndex:index] setValue:paramName forKey:@"name"];
    [[students objectAtIndex:index] setValue:[NSNumber numberWithUnsignedInteger:paramStudentNumber] forKey:@"studentNumber"];
    [[students objectAtIndex:index] setValue:[NSNumber numberWithUnsignedInteger:paramAge] forKey:@"age"];
...
-(void)liat{
    ...
    if ([students count] > 0){
        ...
        for (Student *thisStudent in students){
            NSLog(@"Person %lu First Name = %@", (unsigned long)counter, thisStudent.name);
        }
    } else {
